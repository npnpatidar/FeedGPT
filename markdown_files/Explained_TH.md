...
India is experiencing early heat alerts, with temperatures rising 3.1-5°C above normal in some regions. The IMD predicts more heatwaves, particularly in eastern and southern India. Heatwaves are declared based on temperature thresholds specific to plains, coasts, and hills. To combat this, Heat Action Plans (HAPs) have been developed across 23 states, focusing on preparedness and mitigation strategies. These plans include early warning systems, public education campaigns, and infrastructure adjustments like cool roofs and tree planting. However, challenges remain in tailoring HAPs to diverse local conditions and ensuring practical implementation. The article emphasizes the need for a nuanced approach to defining heatwaves, considering local factors like urban heat island effects and socio-economic diversity. It calls for consistent vulnerability assessments, targeted interventions for vulnerable populations, dedicated budgets for HAPs, and integration with broader urban resilience and climate adaptation plans.

Wed, 17 Apr 2024 11:31:14 +0530
### [The Gujarat government circular on regulating religious conversions to Buddhism and its implications | Explained](https://www.thehindu.com/news/national/gujarat/what-is-the-gujarat-government-circular-on-regulating-religious-conversions-to-buddhism-and-its-implications-explained/article68067044.ece)

The Gujarat government issued a circular stating Buddhism is a separate religion from Hinduism for conversion purposes. This requires individuals converting from Hinduism to Buddhism to seek district magistrate approval under the Gujarat Freedom of Religion Act, 2003. The clarification addresses inconsistencies in the approval process due to district magistrates' arbitrary interpretations of the Act. The circular aims to reduce judicial litigations and ensure legal compliance. Previously, a 2006 Bill suggesting Jainism and Buddhism as Hindu denominations was withdrawn. The 2003 Act, introduced by then Chief Minister Narendra Modi, criminalizes forced conversions and mandates official permission for conversions. The 2021 amendment further penalizes unlawful conversions, particularly those by marriage, with stringent measures. Challenges to the amendment's constitutionality are pending in the High Court, with a limited stay granted for interfaith marriages. The circular has been welcomed by Dalit groups, facilitating clearer conversion guidelines.
